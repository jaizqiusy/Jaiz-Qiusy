  ...
  return (
    <div className="space-y-4 pb-6">
      ...
      <div className="space-y-2">
        <div className="bg-white rounded-xl shadow-sm px-3 py-2 flex items-center justify-between border border-gray-100">
          <div className="flex items-center gap-2">
            <div className="bg-purple-50 p-1.5 rounded-lg text-purple-900">
            ...
            <div className="flex flex-col">
              <input 
                ...
                className="text-xs font-black text-gray-800 bg-transparent border-none focus:ring-0 p-0"
              />
            </div>
          </div>
          <div className="flex items-center gap-1.5">
            <div className="bg-green-50 px-2 py-0.5 rounded text-[8px] font-black text-green-600 uppercase">Live</div>
        ...
        <div className="p-6 border-b border-gray-50">
          ...
          <div className="grid grid-cols-4 gap-2">
            {runningGridData.map((item) => (
              <motion.div 
                key={item.name} 
                whileHover={item.active ? { scale: 1.05, backgroundColor: "#f0fdf4" } : {}}
